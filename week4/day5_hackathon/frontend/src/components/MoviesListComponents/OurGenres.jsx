    ...
    <div className=" ">
      <div className="flex justify-between items-center py-5 lg:px-10 px-2">
        ...
        <div className="md:block hidden">
          <div className="flex justify-center items-center gap-2 bg-black px-2 rounded-lg py-2">
            <div className="prevBtn-OurGenres bg-[#202020] p-1 cursor-pointer transition-all rounded-sm">
              <ArrowLeft size={24} />
            </div>
            <div className="nextBtn-OurGenres bg-[#202020] p-1 cursor-pointer transition-all rounded-sm ">
              <ArrowRight size={24} />
            </div>
          </div>
        </div>
      ...
      <div className="lg:px-10 px-2">
        <Swiper
          ...
          spaceBetween={30}
          navigation={{
            nextEl: ".nextBtn-OurGenres",
            prevEl: ".prevBtn-OurGenres",
          }}
